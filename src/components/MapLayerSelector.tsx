              ...
              <div className="p-3 space-y-1">
                {forecastLayers.map((layer) => {
                  ...
                  return (
                    ...
                    >
                      <Icon className={cn("w-4 h-4", isActive ? layer.color : "")} />
              ...
              <div className="p-3 space-y-1">
                {satelliteLayers.map((layer) => {
                  ...
                  return (
                    ...
                    >
                      <Satellite className={cn("w-4 h-4", isActive ? "text-primary" : "")} />
                      <span className="font-medium">{layer.label}</span>
                      {isActive && (
                        <div className="ml-auto w-2 h-2 rounded-full bg-primary" />
                      )}
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <button
              ...
              className={cn(
                "flex items-center gap-2 px-4 py-3 bg-card/95 backdrop-blur-xl rounded-xl shadow-lg border border-border/50 hover:shadow-xl transition-all hover:scale-105 active:scale-95",
